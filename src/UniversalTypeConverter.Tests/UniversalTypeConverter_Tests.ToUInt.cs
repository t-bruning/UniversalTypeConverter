...
namespace UniversalTypeConverter.Tests {
    public partial class UniversalTypeConverter_Tests {
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableBool_WithValueNull_ShouldThrowInvalidConversionException() {
            bool? value = null;
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableByte_WithValueNull_ShouldThrowInvalidConversionException() {
            byte? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableChar_WithValueNull_ShouldThrowInvalidConversionException() {
            char? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableDateTime_WithValueNull_ShouldThrowInvalidConversionException() {
            DateTime? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableDecimal_WithValueNull_ShouldThrowInvalidConversionException() {
            decimal? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableDouble_WithValueNull_ShouldThrowInvalidConversionException() {
            double? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableFloat_WithValueNull_ShouldThrowInvalidConversionException() {
            float? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableInt_WithValueNull_ShouldThrowInvalidConversionException() {
            int? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableLong_WithValueNull_ShouldThrowInvalidConversionException() {
            long? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_Object_WithValueNull_ShouldThrowInvalidConversionException() {
            object value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableSByte_WithValueNull_ShouldThrowInvalidConversionException() {
            sbyte? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableShort_WithValueNull_ShouldThrowInvalidConversionException() {
            short? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_String_WithValueAbc_ShouldThrowInvalidConversionException() {
            var value = "abc";
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_String_WithValueNull_ShouldThrowInvalidConversionException() {
            string value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableUInt_WithValueNull_ShouldThrowInvalidConversionException() {
            uint? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableULong_WithValueNull_ShouldThrowInvalidConversionException() {
            ulong? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_UInt_From_NullableUShort_WithValueNull_ShouldThrowInvalidConversionException() {
            ushort? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<uint>(value);
            action.Should().Throw<InvalidConversionException>();
        }
