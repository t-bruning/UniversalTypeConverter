...
namespace UniversalTypeConverter.Tests {
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_Float_From_Bool_WithValueFalse_ShouldReturn_0() {
            ...
            TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value).Should().BeInRange(expectedValue, expectedValue);
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableBool_WithValueNull_ShouldThrowInvalidConversionException() {
            bool? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableByte_WithValueNull_ShouldThrowInvalidConversionException() {
            byte? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableChar_WithValueNull_ShouldThrowInvalidConversionException() {
            char? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableDateTime_WithValueNull_ShouldThrowInvalidConversionException() {
            DateTime? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableDecimal_WithValueNull_ShouldThrowInvalidConversionException() {
            decimal? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableDouble_WithValueNull_ShouldThrowInvalidConversionException() {
            double? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableFloat_WithValueNull_ShouldThrowInvalidConversionException() {
            float? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableInt_WithValueNull_ShouldThrowInvalidConversionException() {
            int? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableLong_WithValueNull_ShouldThrowInvalidConversionException() {
            long? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_Object_WithValueNull_ShouldThrowInvalidConversionException() {
            object value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableSByte_WithValueNull_ShouldThrowInvalidConversionException() {
            sbyte? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableShort_WithValueNull_ShouldThrowInvalidConversionException() {
            short? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_String_WithValueAbc_ShouldThrowInvalidConversionException() {
            var value = "abc";
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_String_WithValueNull_ShouldThrowInvalidConversionException() {
            string value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableUInt_WithValueNull_ShouldThrowInvalidConversionException() {
            uint? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableULong_WithValueNull_ShouldThrowInvalidConversionException() {
            ulong? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
        ...
        [TestMethod]
        public void ConvertTo_Float_From_NullableUShort_WithValueNull_ShouldThrowInvalidConversionException() {
            ushort? value = null;
            Action action = () => TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float>(value);
            action.Should().Throw<InvalidConversionException>();
        }
