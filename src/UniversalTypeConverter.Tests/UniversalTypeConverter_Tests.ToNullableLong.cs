...
namespace UniversalTypeConverter.Tests {
    ...
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_NullableLong_From_NullableBool_WithValueNull_ShouldReturn_Null() {
            ...
            TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<long?>(value).HasValue.Should().BeFalse();
        }
        ...
        [TestMethod]
        public void ConvertTo_NullableLong_From_String_WithValueAbc_ShouldThrowInvalidConversionException() {
            var value = "abc";
