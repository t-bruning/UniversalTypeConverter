...
namespace UniversalTypeConverter.Tests {
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_NullableFloat_From_NullableBool_WithValueNull_ShouldReturn_Null() {
            bool? value = null;
            TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<float?>(value).HasValue.Should().BeFalse();
        }
        ...
        [TestMethod]
        public void ConvertTo_NullableFloat_From_String_WithValueAbc_ShouldThrowInvalidConversionException() {
            var value = "abc";
