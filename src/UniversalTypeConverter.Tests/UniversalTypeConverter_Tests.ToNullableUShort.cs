...
namespace UniversalTypeConverter.Tests {
    public partial class UniversalTypeConverter_Tests {
        ...
        public void ConvertTo_NullableUShort_From_NullableBool_WithValueNull_ShouldReturn_Null() {
            ...
            TB.ComponentModel.UniversalTypeConverter.Instance.ConvertTo<ushort?>(value).HasValue.Should().BeFalse();
        }
        ...
        [TestMethod]
        public void ConvertTo_NullableUShort_From_String_WithValueAbc_ShouldThrowInvalidConversionException() {
            var value = "abc";
