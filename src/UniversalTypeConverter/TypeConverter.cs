...
namespace TB.ComponentModel {
    ...
    public partial class TypeConverter : ITypeConverter {
        ...
        private bool TryConvert(object value, Type destinationType, out object result, ConversionArgs args) {
            ...
            // null is handeld before anything else:
            ...
            if (destinationType.IsGenericNullable()) {
                ...
                return TryConvert(value, coreDestinationType, out result, args);
            }
